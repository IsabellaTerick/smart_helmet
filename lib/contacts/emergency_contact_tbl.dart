...
class EmergencyContactTbl extends StatelessWidget {
  ...
  void deleteSelectedContact(String deviceId, String contId) async {
    try {
      await firestore.collection(deviceId).doc('contacts').collection('list').doc(contId).delete();
                                ...
                                return TableRow(
                                  children: [
                                    ...
                                    tableCell(IconButton(
                                      ...
                                      color: Colors.red,
                                      onPressed: () {
                                        deleteSelectedContact(deviceId, contId);
                                      },
                                    ),
                                  ),
                                ],
